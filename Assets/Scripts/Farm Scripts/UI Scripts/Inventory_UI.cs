...
public class Inventory_UI : MonoBehaviour
{
    ...
    public void SlotDrop(Slot_UI slot)
    {
        ...
        {
            UI_Manager.draggedSlot.inventory.MoveSlot(UI_Manager.draggedSlot.slotID, 
            slot.slotID, slot.inventory, UI_Manager.draggedSlot.inventory.slots[UI_Manager.draggedSlot.slotID].count);
